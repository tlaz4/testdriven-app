...
class TestUserService(BaseTestCase):
    ...
    def test_add_user_invalid_json_keys(self):
        ...
        with self.client:
            response = self.client.post(
                '/users',
                data=json.dumps({'email': 'tyler@test.com', 'password': 'greaterthaneight'}),
                content_type='application/json',
            )
            data = json.loads(response.data.decode())
            self.assertEqual(response.status_code, 400)
    ...
    def test_single_user(self):
        ...
        user = add_user('tyler', 'tyler@test.com', 'greaterthaneight')
    ...
    def test_all_users(self):
        ...
        add_user('tyler', 'tyler@test.com', 'greaterthaneight')
        add_user('frodo', 'frodo@middleearth.nz', 'greaterthaneight')
    ...
    def test_main_add_user(self):
        ...
        with self.client:
            response = self.client.post(
                '/',
                data=dict(username='tyler', email='tyler@notreal.com', password='greaterthaneight'),
